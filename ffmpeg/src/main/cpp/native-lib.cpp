...
Java_me_tang_ffmpeg_FFplay_open(
        JNIEnv* env,
        jobject /* this */,
        jstring url,
        jobject surface) {
...
Java_me_tang_ffmpeg_FFplay_close(
        JNIEnv* env,
        jobject /* this */,
        jlong handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_me_tang_ffmpeg_FFplay_sendEvent(
        JNIEnv* env,
        jobject /* this */,
        jlong handle,
        jint code) {
...
extern "C" JNIEXPORT void JNICALL
Java_me_tang_ffmpeg_FFplay_setVolume(
        JNIEnv* env,
        jobject /* this */,
        jlong handle,
        jlong volume) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_me_tang_ffmpeg_FFplay_duration(
        JNIEnv* env,
        jobject /* this */,
        jlong handle) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_me_tang_ffmpeg_FFplay_currentDuration(
        JNIEnv* env,
        jobject /* this */,
        jlong handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_me_tang_ffmpeg_FFplay_seek(
        JNIEnv* env,
        jobject /* this */,
        jlong handle,
        jlong pos) {
...
extern "C" JNIEXPORT void JNICALL
Java_me_tang_ffmpeg_FFplay_setRate(
        JNIEnv* env,
        jobject /* this */,
        jlong handle,
        jint rate) {
...
extern "C" JNIEXPORT void JNICALL
Java_me_tang_ffmpeg_FFplay_setSurface(
        JNIEnv* env,
        jobject /* this */,
        jlong handle,
        jobject surface) {
